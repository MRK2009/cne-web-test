...
<Note level="warning">
Foxlite is still under development and should not be considered
as fully stable yet. It's still advised that you go for Experimental builds as they
will most likely contain patches for bugs not caught in the latest release candidate.
</Note>
...
- A copy of Codename Engine that has Foxlite.
  ...
  - As of writing, v1.1.0-rc3 is the latest (pre-release) version with Foxlite integration. 
