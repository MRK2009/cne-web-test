...
<Note level="warning">
As of September 7, 2026, Foxlite has replaced Away3D in the CNE ecosystem. 
This article is kept for historical purposes and should not be used after `8378ae0` or 
version `1.1.0-rc2` onwards.

For setting up Foxlite, refer to [this page](./3d.mdx).
</Note>
